...
ActiveRecord::Schema[7.0].define(version: 20_231_010_150_924) do
  ...
  create_table 'exams_profiles', id: false, force: :cascade do |t|
    ...
    t.index %w[exams_id profiles_id], name: 'index_exams_profiles_on_exams_id_and_profiles_id', unique: true
