...
Question.create(question: "¿Quién es ídolo de Boca entre las opciones de abajo?", answer: "Riquelme", wrongAnswer1: "Diego Ceballos", wrongAnswer3: "Ángel Labruna", pointQuestion: 10, exam_id: nil, level_id: 13, wrongAnswer2: "Diego Milito")

Question.create(question: "¿De qué equipo es Marcelo Gallardo?", answer: "River Plate", wrongAnswer1: "Boca Juniors", wrongAnswer3: "Independiente", pointQuestion: 10, exam_id: nil, level_id: 13, wrongAnswer2: "Racing")
...
Question.create(question: "¿Cómo se llama el estadio de River Plate?", answer: "El Monumental", wrongAnswer1: "La Bombonera", wrongAnswer3: "El Cilindro", pointQuestion: 10, exam_id: nil, level_id: 13, wrongAnswer2: "El Cementerio de Elefantes")
...
Question.create(question: "¿Quién es el argentino con más mundiales?", answer: "Daniel Passarella", wrongAnswer1: "Diego Armando Maradona", wrongAnswer3: "Mario Alberto Kempes", pointQuestion: 15, exam_id: nil, level_id: 14, wrongAnswer2: "Claudio Caniggia")
...
Question.create(question: "¿En qué año ganó se jugó la final entre Estudiantes de La Plata y Barcelona?", answer: "2009", wrongAnswer1: "2006", wrongAnswer3: "2008", pointQuestion: 20, exam_id: nil, level_id: 15, wrongAnswer2: "2007")
...
Question.create(question: "¿En qué año Independiente ganó su última Libertadores?", answer: "1975", wrongAnswer1: "1991", wrongAnswer3: "1983", pointQuestion: 20, exam_id: nil, level_id: 15, wrongAnswer2: "1984")
...
Question.create(question: "¿Quién cantaba en Soda Stereo?", answer: "Gustavo Cerati", wrongAnswer1: "Fito Páez", wrongAnswer3: "Luis Spinetta", pointQuestion: 5, exam_id: nil, level_id: 1, wrongAnswer2: "Charly García")
...
Question.create(question: "¿Quién tiene la BZRP Session más escuchada?", answer: "Shakira", wrongAnswer1: "Quevedo", wrongAnswer3: "Nathy Peluso", pointQuestion: 5, exam_id: nil, level_id: 1, wrongAnswer2: "Nicki Nicole")
...
Question.create(question: "¿Qué cantante es conocido como la cara del trap argentino?", answer: "Duki", wrongAnswer1: "Paulo Londra", wrongAnswer3: "Ysy A", pointQuestion: 5, exam_id: nil, level_id: 1, wrongAnswer2: "Neo Pistea")
...
Question.create(question: "¿Qué instrumento era el principal de Fito Páez?", answer: "Teclados", wrongAnswer1: "Cuerdas", wrongAnswer3: "Ninguno", pointQuestion: 10, exam_id: nil, level_id: 2, wrongAnswer2: "Teclados y cuerdas")
...
Question.create(question: "¿En qué estadio argentino grabó su disco AC/DC?", answer: "El Monumental", wrongAnswer1: "La Bombonera", wrongAnswer3: "Vélez", pointQuestion: 10, exam_id: nil, level_id: 2, wrongAnswer2: "El Cilindro")
...
Question.create(question: "¿Cuál es el disco más vendido de la historia del país?", answer: "El amor después del amor", wrongAnswer1: "SEP7IMO DÍA", wrongAnswer3: "Ahí vamos", pointQuestion: 10, exam_id: nil, level_id: 2, wrongAnswer2: "Fuerza Natural")

Question.create(question: "¿En qué año murió Spinetta?", answer: "2012", wrongAnswer1: "2014", wrongAnswer3: "2008", pointQuestion: 15, exam_id: nil, level_id: 3, wrongAnswer2: "2001")
...
Question.create(question: "¿En qué año se estrenó El Secreto de sus Ojos?", answer: "2009", wrongAnswer1: "2007", wrongAnswer3: "2012", pointQuestion: 15, exam_id: nil, level_id: 3, wrongAnswer2: "2011")
Question.create(question: "¿Cuántos Oscars ganó Ricardo Darín?", answer: "1", wrongAnswer1: "0", wrongAnswer3: "2", pointQuestion: 15, exam_id: nil, level_id: 3, wrongAnswer2: "3")
...
Question.create(question: "¿Cuál es la capital de Río Negro?", answer: "Viedma", wrongAnswer1: "Río Negro", wrongAnswer3: "Bariloche", pointQuestion: 10, exam_id: nil, level_id: 8, wrongAnswer2: "Rawson")
Question.create(question: "¿Cuál es la capital de Buenos Aires?", answer: "La Plata", wrongAnswer1: "Buenos Aires", wrongAnswer3: "C.A.B.A.", pointQuestion: 10, exam_id: nil, level_id: 8, wrongAnswer2: "Avellaneda")
...
Question.create(question: "¿Quién fue el primer presidente de Argentina?", answer: "Bernardino Rivadavia", wrongAnswer1: "Juan Domingo Perón", wrongAnswer2: "Carlos Menem", wrongAnswer3: "Hipólito Yrigoyen", pointQuestion: 5, exam_id: nil, level_id: 10)
...
Question.create(question: "¿Cuál fue la capital de Argentina antes de Buenos Aires?", answer: "Córdoba", wrongAnswer1: "Rosario", wrongAnswer2: "Mendoza", wrongAnswer3: "La Plata", pointQuestion: 5, level_id: 10, exam_id: nil)
Question.create(question: "¿Cuál es la moneda oficial de Argentina?", answer: "Peso argentino", wrongAnswer1: "Dólar", wrongAnswer2: "Sol", wrongAnswer3: "Austral", pointQuestion: 5, level_id: 10, exam_id: nil)
...
Question.create(question: "¿Qué presidente argentino implementó el Plan de Convertibilidad en la década de 1990?", answer: "Carlos Menem", wrongAnswer1: "Néstor Kirchner", wrongAnswer2: "Fernando de la Rúa", wrongAnswer3: "Raúl Alfonsín", pointQuestion: 10, exam_id: nil, level_id: 11)
Question.create(question: "¿En qué año comenzó la Guerra de Malvinas entre Argentina y el Reino Unido?", answer: "1982", wrongAnswer1: "1976", wrongAnswer2: "1990", wrongAnswer3: "2001", pointQuestion: 10, exam_id: nil, level_id: 11)
...
Question.create(question: "¿En qué año se aprobó la Ley de Voto Femenino en Argentina?", answer: "1947", wrongAnswer1: "1955", wrongAnswer2: "1930", wrongAnswer3: "1960", pointQuestion: 10, level_id: 11, exam_id: nil)
